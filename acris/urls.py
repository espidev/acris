...
urlpatterns = [
    ...
    path('api/playlist/<int:playlist_id>/tracks', views.PlaylistRoute.as_view(), name='playlist-tracks'),
    ...
    path('api/album/<int:album_id>/tracks', views.AlbumRoute.as_view(), name='collection-album-tracks'),
    ...
    path('api/artist/<int:artist_id>/tracks', views.ArtistRoute.as_view(), name='artist-tracks'),
    ...
    path('api/genre/<str:genre_id>/tracks', views.GenreRoute.as_view(), name='genre-tracks'),
